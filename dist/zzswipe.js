...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/lixianfeng/Documents/work/git/zz-swipe/src/Swipe.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-c5dcfa66&file=Swipe.vue!./../node_modules/less-loader/index.js!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Swipe.vue", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-c5dcfa66&file=Swipe.vue!./../node_modules/less-loader/index.js!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Swipe.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    computed: {
	         ...
	         * 图片容器总宽度
	         */
	        spacingVal: function spacingVal() {
	            var val = this.indicatorsSpacing,
	                num = /^[\d\.]+/g.exec(val)[0],
	    ...
	    watch: {
	         ...
	         */
	        currenTranslateX: function currenTranslateX(val) {
	    ...
	    methods: {
	        swipeleftHandler: function swipeleftHandler(e) {
	            if (this.disableCustom) return;
	            this.swipeImg('left');
	        },
	        swiperightHandler: function swiperightHandler(e) {
	            if (this.disableCustom) return;
	            this.swipeImg('right');
	        },
	         ...
	         */
	        swipeImg: function swipeImg(type) {
	            var _this2 = this;
	         ...
	         * transform同
	         */
	        resetBoundaryImg: function resetBoundaryImg(direction) {
	            var _this3 = this;
	            ...
	            setTimeout(function () {
	                _this3.setTransition(swipe, 'transform 0ms ease-in-out');
	                _this3.currenTranslateX = -_this3.width * newIndex + 'px';
	            }, this.duration);
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function () {
	  ...
	  var vueTouch = {};
	  var Hammer =  true ? __webpack_require__(8) : window.Hammer;
