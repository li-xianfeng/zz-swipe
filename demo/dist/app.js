...
/***/ function(module, exports, __webpack_require__) {
	...
	var _zzswipe = __webpack_require__(5);

	var _zzswipe2 = _interopRequireDefault(_zzswipe);
	...
	new _vue2.default({
	    el: '#app',
	    components: {
	        'zz-swipe': _zzswipe2.default
	    },
	    data: function data() {
	        return {
	            imgs: ['http://pic1.58cdn.com.cn//p1/big/n_v1bl2lwkoytsuvomigzu2q_d016075a4f426d09.png', 'http://pic1.58cdn.com.cn//p1/big/n_v1bj3gzsbikdhfp2rxejra_e219ad2f289ed6de.jpg?width=750&height=2113?w=360&h=1014.24', 'http://pic1.58cdn.com.cn//p1/big/n_v1bl2lwklxlxlvooxwzzaq_d016075a4f426d09.png']
	        };
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function () {
	  ...
	  var vueTouch = {};
	  var Hammer =  true ? __webpack_require__(4) : window.Hammer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/******/return __webpack_require__(0);/******/}(/************************************************************************//******/[/* 0 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _Swipe=__webpack_require__(1);var _Swipe2=_interopRequireDefault(_Swipe);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default=_Swipe2.default;/***/},/* 1 *//***/function(module,exports,__webpack_require__){var __vue_script__,__vue_template__;__webpack_require__(2);__vue_script__=__webpack_require__(6);__vue_template__=__webpack_require__(9);module.exports=__vue_script__||{};if(module.exports.__esModule)module.exports=module.exports.default;if(__vue_template__){(typeof module.exports==="function"?module.exports.options:module.exports).template=__vue_template__;}if(false){(function(){module.hot.accept();var hotAPI=require("vue-hot-reload-api");hotAPI.install(require("vue"),true);if(!hotAPI.compatible)return;var id="/Users/lixianfeng/Documents/work/git/zz-swipe/src/Swipe.vue";if(!module.hot.data){hotAPI.createRecord(id,module.exports);}else{hotAPI.update(id,module.exports,__vue_template__);}})();}/***/},/* 2 *//***/function(module,exports,__webpack_require__){// style-loader: Adds some css to the DOM by adding a <style> tag
	// load the styles
	...
	if(!content.locals){module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-c5dcfa66&file=Swipe.vue!./../node_modules/less-loader/index.js!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Swipe.vue",function(){var newContent=require("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-c5dcfa66&file=Swipe.vue!./../node_modules/less-loader/index.js!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Swipe.vue");if(typeof newContent==='string')newContent=[[module.id,newContent,'']];update(newContent);});}// When the module is disposed, remove the <style> tags
	...
	// module
	exports.push([module.id,".zzui-swipe-container {\n  width: 100%;\n  overflow: hidden;\n  position: relative;\n}\n.zzui-swipe-imgs {\n  height: 100%;\n  position: absolute;\n  left: 0;\n}\n.zzui-swipe-item {\n  height: 100%;\n  float: left;\n  position: relative;\n  background-size: cover;\n  background-repeat: no-repeat;\n  background-position: center center;\n}\n.zzui-show-whole {\n  background-size: 100% 100%;\n}\n.zzui-swipe-points {\n  position: absolute;\n  bottom: 0.53rem;\n  left: 50%;\n  z-index: 10;\n  -webkit-transform: translate(-50%, 0);\n          transform: translate(-50%, 0);\n}\n.zzui-swipe-point {\n  display: inline-block;\n  width: 0.53rem;\n  height: 0.53rem;\n  border-radius: 50%;\n  margin: 0 0.1325rem 0 0.1325rem;\n}\n",""]);// exports
	/***/},/* 4 *//***/function(module,exports){"use strict";/*
	...
	css+="\n/*# sourceMappingURL=data:application/json;base64,"+btoa(unescape(encodeURIComponent(JSON.stringify(sourceMap))))+" */";}var blob=new Blob([css],{type:"text/css"});var oldSrc=linkElement.href;linkElement.href=URL.createObjectURL(blob);if(oldSrc)URL.revokeObjectURL(oldSrc);}/***/},/* 6 *//***/function(module,exports,__webpack_require__){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _vueTouch=__webpack_require__(7);var _vueTouch2=_interopRequireDefault(_vueTouch);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}exports.default={data:function data(){return{currentIndex:0,currenTranslateX:0,isAmaniting:false};},props:{imgs:{type:Array,default:function _default(){return[];}},/*
		         ...
		         */showWholeImg:{type:Boolean,default:false},/*
		         * 是否显示底部小圆点
		         */showIndicators:{type:Boolean,default:true},/*
		         * 圆点默认颜色
		         */indicatorsColor:{type:String,default:'#dbd8d8'},/*
		         * 正在展示的图片对应圆点的颜色
		         */indicatorsActiveColor:{type:String,default:'#ffffff'},/*
		         * 圆点位置（离底部高度）
		         */indicatorsPosition:{type:String,default:'0.53rem'},/*
		         * 圆点尺寸
		         */indicatorsSize:{type:String,default:'0.53rem'},/*
		         * 圆点之间的距离
		         */indicatorsSpacing:{type:String,default:'0.53rem'}},computed:{/*
		         * 单张图片宽度（占满整行）
		         */width:function width(){return document.documentElement.clientWidth;},initLeft:function initLeft(){return-this.width+'px';},/*
		         * 图片容器总宽度
		         */imgsWidth:function imgsWidth(){var length=this.imgs.length;return this.width*(length+2)+'px';},/*
		         * 是否多张图片
		         */isMultiple:function isMultiple(){return this.imgs.length>1;},/*
		         * 图片容器总宽度
		         */spacingVal:function spacingVal(){var val=this.indicatorsSpacing,num=/^[\d\.]+/g.exec(val)[0],unit=val.replace(num,'');return'0 '+parseFloat(num)/2+unit+' 0 '+parseFloat(num)/2+unit;}},watch:{/*
		         * 每次滑动为transform属性设置新的translate值
		         */currenTranslateX:function currenTranslateX(val){this.setTransform(this.$els.swipe,'translate3d('+val+',0,0)');}},ready:function ready(){/*
		         * 初始化自动轮播功能
		         */if(0<this.auto&&this.duration<this.auto){this.initAuto();}else{if(this.auto!==0)console.warn('property auto将被忽略；因为auto应同时大于0和this.duration');}},methods:{swipeleftHandler:function swipeleftHandler(e){if(this.disableCustom)return;this.swipeImg('left');},swiperightHandler:function swiperightHandler(e){if(this.disableCustom)return;this.swipeImg('right');},/*
		         * 父组件可监听clickswipe事件处理图片点击
		         * @params [Number] index 目标图片的index
		         */clickHandler:function clickHandler(index){this.$dispatch('clickswipe',index);},initAuto:function initAuto(){var _this=this;setInterval(function(){_this.swipeImg('left');},this.auto);},/*
		         * 通过translate移动图片container实现图片切换效果
		         */swipeImg:function swipeImg(type){var _this2=this;if(this.isAmaniting)return;var swipeWidth=this.width,currentIndex=this.currentIndex,childrenCount=this.imgs.length,swipe=this.$els.swipe;this.setTransition(swipe,'transform '+this.duration+'ms ease-in-out');if(type=='left'){this.currentIndex+=1;}else{this.currentIndex-=1;}this.isAmaniting=true;this.currenTranslateX=-1*this.currentIndex*swipeWidth+'px';setTimeout(function(){_this2.isAmaniting=false;},this.duration);// 滑到最后一张替补图切换第一张
	if(this.currentIndex==childrenCount)this.resetBoundaryImg('left');// 换到开始一张替补图切换最后一张
	if(this.currentIndex<0)this.resetBoundaryImg('right');},/*
		         * 边界图片设置
		         * transform同
		         */resetBoundaryImg:function resetBoundaryImg(direction){var _this3=this;var newIndex=0,swipe=this.$els.swipe,childrenCount=this.imgs.length;if(direction==='right')newIndex=childrenCount-1;this.currentIndex=newIndex;setTimeout(function(){_this3.setTransition(swipe,'transform 0ms ease-in-out');_this3.currenTranslateX=-_this3.width*newIndex+'px';},this.duration);},/*
		         * transition添加浏览器前缀
		         * transform同
		         */setTransition:function setTransition(ele,val){ele.style.transition=val;ele.style.WebkitTransition='-webkit-'+val;ele.style.MozTransition='-moz-'+val;ele.style.OTransition='-o-'+val;},setTransform:function setTransform(ele,val){ele.style.transform=val;ele.style.WebkitTransform=val;ele.style.MozTransform=val;ele.style.OTransform=val;}}};// </script>
	//
	// <template>
	...
	// </style>
	// <script>
	/***/},/* 7 *//***/function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__;'use strict';var _typeof=typeof Symbol==="function"&&_typeof2(Symbol.iterator)==="symbol"?function(obj){return typeof obj==='undefined'?'undefined':_typeof2(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol?"symbol":typeof obj==='undefined'?'undefined':_typeof2(obj);};;(function(){var vueTouch={};var Hammer=true?__webpack_require__(8):window.Hammer;var gestures=['tap','pan','pinch','press','rotate','swipe'];var directions=['up','down','left','right','horizontal','vertical','all'];var customEvents={};if(!Hammer){throw new Error('[vue-touch] cannot locate Hammer.js.');}// exposed global options
	...
	if(this.handler){mc.off(event,this.handler);}if(typeof fn!=='function'){this.handler=null;console.warn('[vue-touch] invalid handler function for v-touch: '+this.arg+'="'+this.descriptor.raw);}else{mc.on(event,this.handler=fn);}},unbind:function unbind(){if(this.handler){this.mc.off(this.arg,this.handler);}if(!Object.keys(this.mc.handlers).length){this.mc.destroy();this.el.hammer=null;}}});Vue.directive('touch-options',{priority:Vue.directive('on').priority+1,update:function update(options){var opts=this.el.hammerOptions||(this.el.hammerOptions={});if(!this.arg){console.warn('[vue-touch] recognizer type argument for v-touch-options is required.');}else{opts[this.arg]=options;}}});};/**
		   ...
		   *                           required fields:
		   *                           - type: the base recognizer to use for this event
		   */vueTouch.registerCustomEvent=function(event,options){options.event=event;customEvents[event]=options;};function capitalize(str){return str.charAt(0).toUpperCase()+str.slice(1);}function guardDirections(options){var dir=options.direction;if(typeof dir==='string'){var hammerDirection='DIRECTION_'+dir.toUpperCase();if(directions.indexOf(dir)>-1&&Hammer.hasOwnProperty(hammerDirection)){options.direction=Hammer[hammerDirection];}else{console.warn('[vue-touch] invalid direction: '+dir);}}}if((false?'undefined':_typeof(exports))=="object"){module.exports=vueTouch;}else if(true){!(__WEBPACK_AMD_DEFINE_ARRAY__=[],__WEBPACK_AMD_DEFINE_RESULT__=function(){return vueTouch;}.apply(exports,__WEBPACK_AMD_DEFINE_ARRAY__),__WEBPACK_AMD_DEFINE_RESULT__!==undefined&&(module.exports=__WEBPACK_AMD_DEFINE_RESULT__));}else if(window.Vue){window.VueTouch=vueTouch;Vue.use(vueTouch);}})();/***/},/* 8 *//***/function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_RESULT__;'use strict';var _typeof=typeof Symbol==="function"&&_typeof2(Symbol.iterator)==="symbol"?function(obj){return typeof obj==='undefined'?'undefined':_typeof2(obj);}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol?"symbol":typeof obj==='undefined'?'undefined':_typeof2(obj);};/*! Hammer.JS - v2.0.7 - 2016-04-22
		 * http://hammerjs.github.io/
		 *
		 * Copyright (c) 2016 Jorik Tangelder;
